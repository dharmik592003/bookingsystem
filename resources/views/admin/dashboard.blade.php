...
@section('main')
  <div class="container-fluid">
    ...
    <div class="col-lg-3 col-6">
      ...
      <a href="#" class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover">More
...
@section('script')
  ...
  <script>
    ...
    let html = ` <div id='contant'>
      <form action="/addservice" method="post">
      @csrf
       <label for="exampleInputEmail1" class="form-label label" >Service</label>
      <input type="text" name="services" class="form-control" id="exampleInputEmail1"
      aria-describedby="emailHelp">
       <button type="submit" class="btn btn-primary">Submit</button>         </form> </div>`
    $('#contant').replaceWith(html)
    $('#modal-title').html('service')
    })
