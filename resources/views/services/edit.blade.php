        ...
        <form class="" action="/addservice" method="post" enctype="multipart/form-data">
            ...
            <div class="step active" data-step="1">
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        <input type="text" name="name" value="{{ $details->name }}" id="category_name"
                            class="form-control" />
                        <label class="form-label" for="form3Example1c">you service
                            name</label>
                    </div>
                </div>
                ...
                <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                        <textarea type="password" name="desc" id="form3Example4c" class="form-control"></textarea>
            ...
            <div class="step" data-step="2">
                ...
                <div class="typeform">
                    <div class=" row d-flex align-items-center justify-content-center flex-row" id="base">
                        ...
                        <div data-mdb-input-init class="col-xl-3 form-group form-outline flex-fill mb-0">
                            <label class="form-label" for="form3Example1c">set the price of your type service
                                name</label>
                            <input type="text" name="price" value="" placeholder="price  total₹" id="category_name"
                                class="form-control" />
                        </div>
                        <div class="terms">
                            <div class="terms">
                                ...
                                <div class="cars" id="cars" style="display: none;">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="driver_price"
                                            placeholder="if driver is demanded if not place the price" id="">
                                    </div>
                                    <div>
                                        <div>
                                            <input type="checkbox" class="form-check-input" name="toll" id="">
                                ...
                                <div class="yacht" id="yacht" style="display: none;">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="dockage_price"
                                            placeholder="if dockage fees is demanded if not place the price" id="">
                                    </div>
                                </div>
                                <div class="planes" id="planes" style="display: none;">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="pilot_price"
                                            placeholder="place the price of pilot" id="">
                                    </div>
                                                                        ...
                                                                        <div class=" row d-flex align-items-center justify-content-center flex-row" id="base">
                                                                            ...
                                                                            <div class=" col-xl-3 form-group">
                                                                                ...
                                                                                <div data-mdb-input-init class="form-outline flex-fill mb-0">
                                                                                    <label class="form-label" for="form3Example1c">set the price of your type service
                                                                                        name</label>
                                                                                    <input type="text" name="price" value="" placeholder="price  per/(day/night) ₹"
